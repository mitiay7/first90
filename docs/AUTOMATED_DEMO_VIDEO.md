...
- The GPT‑5.6 scene must receive a live Responses API result. Validation fails if it does not.
...
Generated evidence includes exact audio inspection, timeline, browser recording report, console and API logs, Playwright trace, FFmpeg command and log, and final codec/state validation.
